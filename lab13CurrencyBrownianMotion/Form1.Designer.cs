namespace lab13CurrencyBrownianMotion
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.edMuDollar.Minimum = new decimal(new int[] {
            10,
            0,
            0,
            -2147483648});
            ...
            this.edMuEuro.Minimum = new decimal(new int[] {
            10,
            0,
            0,
            -2147483648});
            ...
            this.edSigmaDollar.Minimum = new decimal(new int[] {
            10,
            0,
            0,
            -2147483648});
            ...
            this.edSigmaEuro.Minimum = new decimal(new int[] {
            10,
            0,
            0,
            -2147483648});
